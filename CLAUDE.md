...
- **`claude/CLAUDE.md`** is the global Claude Code instructions file (applies to all projects via `~/.claude/CLAUDE.md`). This repo's `CLAUDE.md` (this file) is repo-specific.
